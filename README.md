...
The main README.md file is sorted by language and the [BYTOPIC.md](BYTOPIC.md) file is sorted by the topic that `starred` generated in case you want different filtering. I will work on modifying this so that it's sorted by categories that make sense later/match my personal categories and will also work on automating this to update when I add more in the future!

Stay tuned for further updates and hope everyone finds this mildly helpful!
