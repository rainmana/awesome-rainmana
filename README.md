...
- [CleoV2/Babel-Deobfuscator](https://github.com/CleoV2/Babel-Deobfuscator) - Babel-Deobfuscator is an open-source deobfuscator for Babel Obfuscator.
...
- [Xinyuan-LilyGO/LilyGoLib](https://github.com/Xinyuan-LilyGO/LilyGoLib) - T-Deck & T-Watch Ultra &  T-LoRa-Pager & T-Watch-S3 & T-Watch-S3-Plus
...
- [JeanExtreme002/FlightRadarAPI](https://github.com/JeanExtreme002/FlightRadarAPI) - :airplane: Unofficial SDK for FlightRadar24 for Python 3, NodeJS and Golang.
...
- [mitre-attack/attack-workbench-rest-api](https://github.com/mitre-attack/attack-workbench-rest-api) - An application allowing users to explore, create, annotate, and share extensions of the MITRE ATT&CK® knowledge base. This repository contains the REST API service for storing, querying, and editing A
...
- [bellingcat/open-questions](https://github.com/bellingcat/open-questions) - Archived repository of difficult, long-term projects that could be valuable to open source investigators at Bellingcat and around the world.
...
- [yriveiro/wezterm-tabs](https://github.com/yriveiro/wezterm-tabs) - WezTerm to configure tabs look and feel
...
- [anhsirk0/wezterm-themes](https://github.com/anhsirk0/wezterm-themes) - Port of Ef-themes, Doric-themes and Modus-themes for wezterm
- [koh-sh/wezterm-theme-rotator](https://github.com/koh-sh/wezterm-theme-rotator) - A plugin for WezTerm that allows you to easily switch between all built-in themes using keyboard shortcuts.
- [neapsix/wezterm](https://github.com/neapsix/wezterm) - Soho vibes for WezTerm
...
- [veniceai/api-docs](https://github.com/veniceai/api-docs) - Docs powering https://docs.venice.ai
...
- [Rafi993/tiny](https://github.com/Rafi993/tiny) - Tiny alternative to electron
...
- [servicelogon/awesome-recon-tools](https://github.com/servicelogon/awesome-recon-tools) - A compiled list of tools for reconnaissance and footprinting
...
- [edoardogerosa/sentinel-attack](https://github.com/edoardogerosa/sentinel-attack) - Tools to rapidly deploy a threat hunting capability on Azure Sentinel that leverages Sysmon and MITRE ATT&CK
...
- [IBM/chuk-tool-processor](https://github.com/IBM/chuk-tool-processor) - 
...
- [0cyn/bn-dyldsharedcache](https://github.com/0cyn/bn-dyldsharedcache) - this was a single-image DSC parser predating official support for DSC support in binaryninja.
...
- [symgraph/BinAssistMCP](https://github.com/symgraph/BinAssistMCP) - Binary Ninja plugin to provide MCP functionality.
...
- [Kawai-Senpai/PotatoDB](https://github.com/Kawai-Senpai/PotatoDB) - PotatoDB is a lightweight, file-based NoSQL database for Python projects, designed for easy setup and use in small-scale applications. Ideal for developers seeking simple data persistence without the 
- [Skycards/Changes](https://github.com/Skycards/Changes) - 
...
- [WikiExtractor/wikiextractor](https://github.com/WikiExtractor/wikiextractor) - A tool for extracting plain text from Wikipedia dumps
...
- [ytisf/PyExfil](https://github.com/ytisf/PyExfil) - PyExfil — Python 3 toolkit for researching and stress-testing data exfiltration techniques across network, physical, and steganographic channels. For red team simulation and DLP detection testing.
...
- [alexdlaird/hookee](https://github.com/alexdlaird/hookee) - Command line webhooks, on demand; tunnel, capture, and script responses
...
- [IBM/IBM-Z-zOS](https://github.com/IBM/IBM-Z-zOS) - The helpful and handy location for finding and sharing z/OS files, which are not included in the product.
